...
export default function Settings() {
  ...
  const handleSavePassword = (e) => {
     ...
     */
    localStorage.setItem("ecodas_password_updated", new Date().toISOString());
  ...
  const handleSavePreferences = () => {
    ...
    localStorage.setItem("ecodas_preferences", JSON.stringify(preferences));
  ...
  const handleExportData = () => {
    ...
    if (isAdmin) {
      ...
      data = {
        ...
        students: JSON.parse(localStorage.getItem("ecodas_students") || "[]"),
    ...
    link.href = url;
    link.download = isAdmin ? "ecodas-admin-data.json" : "ecodas-my-data.json";
        ...
        <main className="settings-content">
          ...
          {activeSection === "profile" && (
            <section className="settings-section">
              <div className="settings-section-heading">
                <div>
                  <h2>
                    {isAdmin ? "Informasi administrator" : "Informasi akun"}
                  </h2>
                  ...
                  {!isAdmin && (
                    <div className="settings-field">
                      ...
                      <input
                        ...
                        disabled={!isEditing}
                        onChange={(e) =>
                          handleProfileChange("studyProgram", e.target.value)
                        }
                      />
                    </div>
                  )}
              ...
              {isAdmin && (
                <div className="settings-card">
                  <div className="settings-card-title">Akses administrator</div>
          ...
          {activeSection === "security" && (
            <section className="settings-section">
              ...
              <div className="settings-card">
                <div className="settings-card-title">Ubah password</div>
                ...
                <form onSubmit={handleSavePassword}>
                  {[
                    ...
                    <div className="settings-field password-field" key={key}>
                      <label>{label}</label>
              ...
              <div className="settings-card">
                <div className="settings-card-title">Sesi saat ini</div>
          ...
          {activeSection === "preferences" && (
            <section className="settings-section">
              ...
              {isAdmin ? (
                <>
                  <div className="settings-card">
                    ...
                    <SettingToggle
                      ...
                      onChange={() =>
                        handleAdminPreference("reviewNotification")
                      }
                    />
                    ...
                    <SettingToggle
                      ...
                      onChange={() =>
                        handleAdminPreference("systemNotification")
                      }
                    />
                    ...
                    <SettingToggle
                      ...
                      onChange={() => handleAdminPreference("weeklyReport")}
                    />
                    ...
                    <SettingToggle
                      ...
                      onChange={() => handleAdminPreference("dataAlert")}
                    />
                    ...
                    <SettingToggle
                      ...
                      onChange={() => handleAdminPreference("collectiveUpdate")}
                    />
                  </div>
                </>
              ) : (
                ...
                <div className="settings-card">
                  ...
                  <SettingToggle
                    ...
                    checked={studentPreferences.activityNotification}
                    onChange={() =>
                      handleStudentPreference("activityNotification")
                    }
                  />
                  ...
                  <SettingToggle
                    ...
                    onChange={() => handleStudentPreference("habitReminder")}
                  />
                  ...
                  <SettingToggle
                    ...
                    onChange={() => handleStudentPreference("weeklyFeedback")}
                  />
                </div>
              )}
              ...
              <div className="settings-card">
                <div className="settings-card-title">Tampilan</div>

                <div className="settings-select-row">
                  <div>
                    <strong>Bahasa</strong>

                    <p>Bahasa yang digunakan pada antarmuka.</p>
                  </div>
          ...
          {activeSection === "privacy" && (
            <section className="settings-section">
              <div className="settings-section-heading">
                <div>
                  <h2>{isAdmin ? "Data & privacy" : "Privacy & data"}</h2>
              ...
              {isAdmin && (
                <div className="settings-card">
                  ...
                  <div className="settings-data-info">
                    ...
                    <div>
                      <strong>Data ECODAS pada perangkat</strong>

                      <p>
                        Administrator dapat mengakses data mahasiswa, aktivitas,
                        dan data review prototype yang tersimpan pada perangkat.
                      </p>
                    </div>
                  </div>
              ...
              <div className="settings-card">
                <div className="settings-card-title">
                  {isAdmin ? "Export data sistem" : "Data kamu"}
                </div>
                ...
                <div className="privacy-action">
                  ...
                  <div>
                    <strong>
                      {isAdmin ? "Export data administrasi" : "Export data"}
                    </strong>
              ...
              <div className="settings-danger">
                ...
                <div className="danger-action">
                  ...
                  <button
                    ...
                    onClick={
                      isAdmin ? handleResetAdminData : handleResetStudentData
                    }
                  >
                    <Trash2 size={16} />
                    Reset data
          ...
          <div className="settings-logout-card">
            <div>
              ...
              <p>
                Akhiri sesi {isAdmin ? "administrator" : "mahasiswa"} pada
                perangkat ini.
              </p>
            </div>
...
function AdminAccessItem({ icon: Icon, title, description }) {
  return (
